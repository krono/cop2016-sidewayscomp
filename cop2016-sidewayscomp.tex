...
non-standard lookup. This can be achieved by explicitly telling the
...
\item that telling the active layer composition \emph{explicitly} to the
...
\emph{descriptor} holding onto all partial method and possibly a base method.
...
method ``talking'' to the \ac{jit} \emph{promotes} this ordering:
