...
\paragraph{Methodology} Every benchmark was run 10 times
uninterrupted at highest
priority in a new process. The execution time was measured
\emph{in-system} and, hence, does not include start-up; however, warm-up was
not separated, so all times include JIT compilation. We
show the arithmetic mean of all  runs along with
