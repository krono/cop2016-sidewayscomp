...
ContextJS~\cite{lincke+:2011:open-implementation}\footnote{\url{https://github.com/LivelyKernel/LivelyKernel/tree/master/core/cop}
  revision 0bd117c.} with Chrome 50.0.2661.66 beta (64-bit) on OS\,X, Edge
25.10586 on Windows 10 and Chrome 49.0.2623.112 on Windows 10; as well as
LispWorks\textsuperscript{\textregistered} 64-bit on OS\,X.
